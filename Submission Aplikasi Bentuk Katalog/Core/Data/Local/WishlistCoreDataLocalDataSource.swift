...
class WishlistCoreDataLocalDataSource {
    ...
    static let shared = WishlistCoreDataLocalDataSource()
...
extension WishlistCoreDataLocalDataSource: GameCatalogDetailRemoteDataSource {
